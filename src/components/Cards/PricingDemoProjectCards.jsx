...
const projectDataRows = [
  {
    ...
    description: {
      ...
      zh: "国际学习顾问计划为寻求海外教育机会的学生提供个性化指导。该计划提供专家建议，帮助学生选择机构、导航申请流程和为国际学习做准备。",
    },
  ...
  },
  {
    ...
    description: {
      ...
      zh: "在线商店，提供高品质的个人防护装备（PPE），包括手套、口罩和检测试剂盒。提供实惠的价格、可靠的防护和全面的PPE解决方案。",
    },
    cost: "$80,000",
    cost_zh: "￥580,000",
  },
  {
    ...
    description: {
      ...
      zh: "全方位的IT服务平台，提供云解决方案、网站开发和数字化转型服务。集成了先进的项目管理和客户沟通工具。",
    },
    cost: "$50,000",
    cost_zh: "￥360,000",
  },
  {
    ...
    description: {
      ...
      zh: "移动共享电源：手机扫码可以借用电池为手机充电，简单快捷。可以从附近的任何站点借用电池，充电后归还到附近的任何站点。",
    },
    cost: "$50,000",
    cost_zh: "￥360,000",
  ...
  },
  {
    ...
    description: {
      ...
      zh: "现代化的技术博客和知识分享平台。功能包括文章管理、代码片段分享和互动讨论。使用Next.js和MongoDB构建。",
    },
    cost: "$30,000",
    cost_zh: "￥220,000",
  },
  {
    ...
    description: {
      ...
      zh: "预约平台包括对移动应用程序的全面支持，提高了用户的可访问性和便利性。确保了预约的无缝安排和管理。",
    },
  ...
  },
  {
    ...
    description: {
      ...
      zh: "为国际互惠生服务开发的全方位数字解决方案，包括响应式网站和微信小程序。包含档案、家庭匹配和在线申请功能。帮助提升用户参与度150%。",
    },
    cost: "$25,000",
    cost_zh: "￥180,000",
